   ...
   <header></header>
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <c:choose>
			...
			<c:forEach var="profile" items="${view}" varStatus="status">
       			<p class="w3-center">${profile.userName}</p>
       			<p class="w3-center">${profile.userId}</p>
       		</c:forEach>
       		</c:when>
	       	<c:otherwise>
        ...
        <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i><a> 회원정보 수정</a></p>
